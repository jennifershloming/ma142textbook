...
Above you can see the star polygon called "five two", which Donald Duck has on his hand in this movie. You can see this symbolically on your right. You are going to learn how to name Star Polygons, draw them, and more in this mini-lecture.
...
Step 1: Visualize a circle and place $n$ equally spaced dots around it. If we had $n = 10$ then we would have 10 equally spaced dots. If we had $n = 5$ then we have 5 dots in an equally spaced circle. Try your best to have it equally spaced.
...
Then we are going to connect every $k$th dot where $k = 2$. If we are connecting every 2nd point then we are doing every other one (skipping one). You can watch me do this here and you should get what you see below.

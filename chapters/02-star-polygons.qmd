...
<figure style="text-align:center; margin: 0.75rem auto 1rem auto;">
   <img src="images/ch2-step2-8-2-connected.svg" alt="Eight equally spaced dots where every second dot is connected." style="width:36%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">Eight equally spaced dots where every second dot is connected.</figcaption>
</figure>
...
<figure style="text-align:center; margin: 0.75rem auto 1rem auto;">
   <img src="images/ch2-step2-8-3-connected.svg" alt="Eight equally spaced dots where every third dot is connected." style="width:36%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">Eight equally spaced dots where every third dot is connected.</figcaption>
</figure>
...
<figure style="text-align:center; margin: 0.75rem auto 1rem auto;">
   <img src="images/ch2-step2-8-4-connected.svg" alt="Eight equally spaced dots where every fourth dot is connected." style="width:36%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">Eight equally spaced dots where every fourth dot is connected.</figcaption>
</figure>
...
<figure style="text-align:center; margin: 0.75rem auto 1rem auto;">
   <img src="images/ch2-step2-8-5-connected.svg" alt="Eight equally spaced dots where every fifth dot is connected." style="width:36%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">Eight equally spaced dots where every fifth dot is connected.</figcaption>
</figure>
...
### Identical Star Polygons

**You can tell without drawing which Star Polygons are going to be <span style="color:#b22222;">identical</span> by using the following:**

$$
\{n/k\} = \{n/(n-k)\}
$$

If this formula looks complicated you can just remember that <span style="color:#1d4ed8;">two Star Polygons are identical when the $n$ values are the same and the bottom values added together give you the top.</span> That will tell you which ones will look exactly the same.
...
(a) $\{n/k\} = \{n/(n-k)\}$ where $n = 10$ and $k = 2$.

Plug in: $\{10/(10-2)\}$.

This gives us $\{10/8\}$.

**$\{10/2\}$ is identical to $\{10/8\}$.**
...
(b) $\{n/k\} = \{n/(n-k)\}$ where $n = 11$ and $k = 2$.

Plug in: $\{11/(11-2)\}$.

This gives us $\{11/9\}$.

**$\{11/2\}$ is identical to $\{11/9\}$.**
...
(c) $\{n/k\} = \{n/(n-k)\}$ where $n = 7$ and $k = 3$.

Plug in: $\{7/(7-3)\}$.

This gives us $\{7/4\}$.

**$\{7/3\}$ is identical to $\{7/4\}$.**
...
Did you get confused with how identical star polygons are found? If so, I made a video of me doing these three examples and narrating the process. You can watch and listen [here](https://youtu.be/cvJRml9PtDU).
...
<figure style="text-align:center; margin: 0.75rem auto 1rem auto;">
   <img src="images/ch2-step2-8-1-connected.svg" alt="Eight equally spaced dots where every dot is connected to the next." style="width:36%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">$\{8/1\} = \{8/7\}$</figcaption>
</figure>

<figure style="text-align:center; margin: 0.75rem auto 1rem auto;">
   <img src="images/ch2-step2-8-2-connected.svg" alt="Eight equally spaced dots where every second dot is connected." style="width:36%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">$\{8/2\} = \{8/6\}$</figcaption>
</figure>

<figure style="text-align:center; margin: 0.75rem auto 1rem auto;">
   <img src="images/ch2-step2-8-3-connected.svg" alt="Eight equally spaced dots where every third dot is connected." style="width:36%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">$\{8/3\} = \{8/5\}$</figcaption>
</figure>

<figure style="text-align:center; margin: 0.75rem auto 1rem auto;">
   <img src="images/ch2-step2-8-4-connected.svg" alt="Eight equally spaced dots where every fourth dot is connected." style="width:36%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">$\{8/4\}$</figcaption>
</figure>
...
### 2.3.3 Regular and Compound Star Polygons

**Star Polygons are called <span style="color:#059669;">Regular</span> if you do NOT need to lift up your pen/pencil/mouse while creating them.**

<span style="color:#059669;">Regular</span> Star Polygons are made in one cycle.
...
<span style="color:#9333ea;">Those Star Polygons that are NOT Regular are called Compound.</span> Compound is a word many of you might associate with "more than one." **<span style="color:#9333ea;">Here they are called Compound Star Polygons because they are created with more than one cycle, aka you have to lift your pen/pencil/mouse more than once.</span>**
...
**<span style="color:#9333ea;">A Regular Star Polygon is denoted by $\{n/k\}$, where $n$ and $k$ are relatively prime (they share no factors except 1) and $k \ge 2$.</span>** <span style="color:#9333ea;">A Compound Star Polygon has common factors besides 1.</span>

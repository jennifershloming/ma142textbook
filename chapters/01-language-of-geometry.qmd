...
![Vertical angles diagram showing opposite angles are congruent.](images/ch1-vertical-angles.svg){fig-align="center" fig-cap="Vertical angles are opposite angles formed by intersecting lines."}

![Right angle diagram showing a 90 degree angle.](images/ch1-right-angle.svg){fig-align="center" fig-cap="A right angle measures 90 degrees."}
...
4. Confidence Check: Label each statement as a **Definition**, **Postulate**, or **Theorem**.

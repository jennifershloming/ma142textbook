...
Make time to read for this course. Try not to leave reading until the day assignments are due. That will add stress and frustration. The lectures are inside and you need to go through them in order to score well on the assignments.

::: {.callout-important}
## Important Course Note

You need to answer questions in this course based on the terms used in this text. If you use terms and methods that I do not use it will signal that you may be using AI as a replacement for the lectures.
:::
...
4. In the rest of the chapters you will see more practice problems. This chapter is all about preparing for the rest of the class and text. I do want you to first figure out how you will be taking notes in this course. Get a binder or notebook ready.

## Art and Design Connections

- In the rest of the chapters you will see specific connections with our topic to art and design. Now that you have seen right angles I want you to go outside tomorrow and notice how many right angles are around us in buildings, signs, and more! My son and I looked at different angles around the Upper West Side in Manhattan for an hour today and right angles were the most common we found. △

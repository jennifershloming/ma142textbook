...
<figure style="text-align:center; margin: 1rem auto;">
   <img src="images/ch8-conic-sections.svg" alt="The four classic conic sections: circle, ellipse, parabola, and hyperbola." style="width:66%; max-width:100%; height:auto;" />
   <figcaption style="text-align:center; margin-top:0.5rem;">The four classic conic sections: circle, ellipse, parabola, and hyperbola.</figcaption>
</figure>
:::
